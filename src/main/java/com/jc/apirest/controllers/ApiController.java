...
public class ApiController {
    ...
    public ResponseEntity<Object> deleteUser(@PathVariable int userId) throws ApiUnprocessableEntity{
        
        this.userValidator.validator(userId);
    ...
    public ResponseEntity<Object> update(@RequestBody UserRequest request, @PathVariable int userId){
        
        this.userServices.update(request, userId);
